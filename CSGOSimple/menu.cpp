...
void RenderEspTab()
{
    ...
    ImGui::BeginGroupBox("##body_content");
    {
        if(active_esp_tab == 0) {
			...
			ImGui::Checkbox("Inaccuracy Circle", &g_Options.esp_inaccuracy_circle);
			ImGui::SliderInt("Circle Segments", &g_Options.esp_circle_segments, 3, 100);
...
void RenderMiscTab()
{
    ...
    ImGui::BeginGroupBox("##body_content");
    {
		...
		ImGui::Checkbox("Fast walk", &g_Options.misc_fastwalk);
