...
namespace Utils
{
	...
	{
		HMODULE client = GetModuleHandle(L"client_panorama.dll");
		if (client == INVALID_HANDLE_VALUE)
		{
			client = GetModuleHandle(L"client.dll");
		}
    ...
    void RankRevealAll()
    {
        ...
        static auto fnServerRankRevealAll = PatternScan(GetClientModule(), "55 8B EC 8B 0D ? ? ? ? 68");
