...
CCSWeaponInfo* C_BaseCombatWeapon::GetCSWeaponData()
{
    static auto fnGetWpnData
        = reinterpret_cast<CCSWeaponInfo*(__thiscall*)(void*)>(
            Utils::PatternScan(Utils::GetClientModule(), "55 8B EC 81 EC ? ? ? ? 53 8B D9 56 57 8D 8B")
            );
...
{
    static auto inReload = *(uint32_t*)(Utils::PatternScan(Utils::GetClientModule(), "C6 87 ? ? ? ? ? 8B 06 8B CE FF 90") + 2);
    return *(bool*)((uintptr_t)this + inReload);
}

float C_BaseCombatWeapon::GetInaccuracy()
{
    return CallVFunction<float(__thiscall*)(void*)>(this, /*483*/470)(this);
}

float C_BaseCombatWeapon::GetSpread()
{
    return CallVFunction<float(__thiscall*)(void*)>(this, /*484*/471 /*probably*/)(this);
}

void C_BaseCombatWeapon::UpdateAccuracyPenalty()
{
    CallVFunction<void(__thiscall*)(void*)>(this, /*485*/447)(this);
}

CUserCmd*& C_BasePlayer::m_pCurrentCommand()
{
    static auto currentCommand = *(uint32_t*)(Utils::PatternScan(Utils::GetClientModule(), "89 BE ? ? ? ? E8 ? ? ? ? 85 FF") + 2);
...
bool C_BasePlayer::HasC4()
{
    static auto fnHasC4
        = reinterpret_cast<bool(__thiscall*)(void*)>(
            Utils::PatternScan(Utils::GetClientModule(), "56 8B F1 85 F6 74 31")
            );
